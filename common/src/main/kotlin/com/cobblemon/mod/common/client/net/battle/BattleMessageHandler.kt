...
object BattleMessageHandler : ClientNetworkPacketHandler<BattleMessagePacket> {
    override fun handle(packet: BattleMessagePacket, client: MinecraftClient) {
        ...
        for (message in packet.messages) {
            ...
            val width = if (BattleMessagePane.expanded) BattleMessagePane.LINE_EXPANDED_WIDTH else BattleMessagePane.LINE_WIDTH
            val lines = Language.getInstance().reorder(textRenderer.textHandler.wrapLines(line, width, line.style))
